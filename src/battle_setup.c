...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_3, TRAINER_ELLIOT_3, TRAINER_ELLIOT_3, TRAINER_ELLIOT_4, TRAINER_ELLIOT_5, MAP_ROUTE106),
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_MAIDEN1, TRAINER_MAIDEN1, TRAINER_MAIDEN1, TRAINER_MAIDEN1, TRAINER_MAIDEN1, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_MAIDEN2, TRAINER_MAIDEN2, TRAINER_MAIDEN2, TRAINER_MAIDEN2, TRAINER_MAIDEN2, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_MAIDEN3, TRAINER_MAIDEN3, TRAINER_MAIDEN3, TRAINER_MAIDEN3, TRAINER_MAIDEN3, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_MAIDEN4, TRAINER_MAIDEN4, TRAINER_MAIDEN4, TRAINER_MAIDEN4, TRAINER_MAIDEN4, MAP_EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_UNOWN_KING_COF_SPE_HOO, TRAINER_UNOWN_KING_COF_SPE_HOO, TRAINER_UNOWN_KING_COF_SPE_HOO, TRAINER_UNOWN_KING_COF_SPE_HOO, TRAINER_UNOWN_KING_COF_SPE_HOO, MAP_EVER_GRANDE_CITY),
};

static const u8 sUnownNickname[] = _("Unown");
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    */
   CreateBattleStartTask(B_TRANSITION_ANGLED_WIPES, MUS_VS_GYM_LEADER);
...
void BattleSetup_StartTrainerBattle(void)
{
    ...
    if (FlagSet(FLAG_BATTLE_NO_REWARD)) {
        gBattleTypeFlags |= BATTLE_TYPE_NO_REWARD;
        FlagClear(FLAG_BATTLE_NO_REWARD);
    }
...
void InitUnownFake(void)
{
    /*
    u32 i;
    for (i = 0; i < 2; i++) {
        gUnownFake[i].level = 1;
        gUnownFake[i].hp = 1;
        gUnownFake[i].maxHP = 1;
        gUnownFake[i].box.hasSpecies = 1;
        StringCopy_Nickname(&gUnownFake[i].box.nickname[0], &sUnownNickname[0]);
    }
    gUnownFake[0].box.secure.substructs[0].type0.species = SPECIES_UNOWN_QUESTION;
    gUnownFake[1].box.secure.substructs[0].type0.species = SPECIES_UNOWN_EXCLAMATION;
    */
    CreateMon(&gUnownFake[0], SPECIES_UNOWN_QUESTION,    1, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
    CreateMon(&gUnownFake[1], SPECIES_UNOWN_EXCLAMATION, 1, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
}
