...
{
    {MAPSEC_UNDERWATER_ETERNAL_POND,    MAPSEC_EAST_OF_TEMPLE},
    {MAPSEC_UNDERWATER_124,             MAPSEC_ROUTE_124},
    #ifdef BUGFIX
    {MAPSEC_UNDERWATER_TEMPLE,          MAPSEC_ROUTE_125},
    #else
    {MAPSEC_UNDERWATER_TEMPLE,          MAPSEC_ROUTE_129}, // BUG: Map will incorrectly display the name of Route 129 when diving on Route 125 (for Marine Cave only)
    #endif
    {MAPSEC_UNDERWATER_126,             MAPSEC_ROUTE_126},
    {MAPSEC_UNDERWATER_127,             MAPSEC_ROUTE_127},
    {MAPSEC_UNDERWATER_128,             MAPSEC_ROUTE_128},
    {MAPSEC_UNDERWATER_POND_OF_GRACE,   MAPSEC_WEST_OF_TEMPLE},
    ...
    {MAPSEC_ABYSS_OF_THE_END,           MAPSEC_ROUTE_134},
    {MAPSEC_ENCLOSED_GARDEN,            MAPSEC_WESTERN_WING},
    {MAPSEC_PITCH_BLACK,                MAPSEC_ROUTE_112},
    {MAPSEC_TEMPLE,                     MAPSEC_ROUTE_122},
    {MAPSEC_SKY_PILLAR,                 MAPSEC_ROUTE_131},
    {MAPSEC_MIRAGE_TOWER,               MAPSEC_ROUTE_111},
    {MAPSEC_TRAINER_HILL,               MAPSEC_ROUTE_111},
    {MAPSEC_DESERT_UNDERPASS,           MAPSEC_ROUTE_114},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_WEST_OF_TEMPLE},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_WEST_OF_TEMPLE},
...
{
    MAPSEC_MARINE_CAVE,
    MAPSEC_UNDERWATER_JAGGED_HALLWAY,
    MAPSEC_UNDERWATER_JAGGED_HALLWAY
};
...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_ROUTE_105_NORTH - 1] = MAPSEC_CHAMBER_OF_TRUTH,
    [ABNORMAL_WEATHER_ROUTE_105_SOUTH - 1] = MAPSEC_CHAMBER_OF_TRUTH,
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_WESTERN_HALLWAY] = {MAP_GROUP(MAP_ROUTE101), MAP_NUM(MAP_ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_EAST_OF_TEMPLE] = {MAP_GROUP(MAP_ROUTE102), MAP_NUM(MAP_ROUTE102), HEAL_LOCATION_NONE},
    [MAPSEC_WEST_OF_TEMPLE] = {MAP_GROUP(MAP_ROUTE103), MAP_NUM(MAP_ROUTE103), HEAL_LOCATION_NONE},
    [MAPSEC_WESTERN_WING] = {MAP_GROUP(MAP_ROUTE104), MAP_NUM(MAP_ROUTE104), HEAL_LOCATION_NONE},
    [MAPSEC_CHAMBER_OF_TRUTH] = {MAP_GROUP(MAP_ROUTE105), MAP_NUM(MAP_ROUTE105), HEAL_LOCATION_NONE},
    [MAPSEC_EASTERN_WING] = {MAP_GROUP(MAP_ROUTE106), MAP_NUM(MAP_ROUTE106), HEAL_LOCATION_NONE},
    [MAPSEC_EASTERN_HALLWAY] = {MAP_GROUP(MAP_ROUTE107), MAP_NUM(MAP_ROUTE107), HEAL_LOCATION_NONE},
...
static void InitMapBasedOnPlayerLocation(void)
{
    ...
    case MAP_TYPE_INDOOR:
        ...
        if (sRegionMap->mapSecId == MAPSEC_UNDERWATER_SEAFLOOR_CAVERN /*|| sRegionMap->mapSecId == MAPSEC_UNDERWATER_JAGGED_HALLWAY*/)
    ...
    */
    ...
    case MAPSEC_ROUTE_121:
        ...
        break;
    /*
    case MAPSEC_UNDERWATER_JAGGED_HALLWAY:
