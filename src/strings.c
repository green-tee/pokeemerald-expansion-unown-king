...
const u8 gText_DadsAdvice[] = _("There's a time and place for everything,\nbut not here and not now.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromMaiden[] = _("An odd Pokémon egg\nobtained from a Maiden.");
...
const u8 gText_TrainerCardPokedex[] = _("Unown");
...
const u8 gText_SavingBadges[] = _("HMs");
const u8 gText_SavingPokedex[] = _("Unown");
...
const u8 gText_LuckyCharmOn[] = _("The Lucky Charm has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_LuckyCharmOff[] = _("The Lucky Charm has been turned off.{PAUSE_UNTIL_PRESS}");
