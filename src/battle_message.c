...
static const u8 sText_BossPkmnAppeared[] = _("You encountered a hostile {B_OPPONENT_MON1_NAME}!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_NORUNNINGFROMBOSSES]                  = COMPOUND_STRING("You can't run from a hostile Pokémon!\p"),
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}\p"),
