...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_BREEDER] = { _("Breeder"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    ...
    [TRAINER_CLASS_MAIDEN] = { _("Maiden"), 25, BALL_ULTRA },
    ...
    [TRAINER_CLASS_BEAST_TAMER] = { _("Beast Tamer"), 12 },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3 },
    [TRAINER_CLASS_FIGHTER] = { _("Fighter"), 6 },
    ...
    [TRAINER_CLASS_SCOUNDREL] = { _("Scoundrel"), 10 },
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 firstTrainer, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            CreateMon(&party[i], partyData[monIndex].species, partyData[monIndex].lvl, 0, TRUE, personalityValue, otIdType, fixedOtId, FALSE);
            ...
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                      ...
                      && gBattleResources->bufferB[battler][1] == B_ACTION_RUN)
                {
                    ...
                    gBattleCommunication[battler] = STATE_BEFORE_ACTION_CHOSEN;
                      ...
                      && gBattleResources->bufferB[battler][1] == B_ACTION_RUN)
                {
                    BattleScriptExecute(BattleScript_PrintCantRunFromBosses);
                    gBattleCommunication[battler] = STATE_BEFORE_ACTION_CHOSEN;
                }
