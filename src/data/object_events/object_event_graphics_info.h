...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Maiden1 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_3,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Maiden2 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_4,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Maiden3 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_2,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Maiden4 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_1,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BeastTamer = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_4,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Scoundrel = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_4,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_CrystalFaint = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_CRYSTAL,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    ...
    .images = sPicTable_CrystalFaint,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_CrystalHeal = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_CRYSTAL,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Crystal,
    .images = sPicTable_CrystalHeal,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_CrystalParty = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_CRYSTAL,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Latias = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_LATIOS_LATIAS,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 2048,
    .width = 64,
    .height = 64,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_UnownKing = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_UNOWN_KING,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 2048,
    .width = 64,
    .height = 64,
    ...
    .oam = &gObjectEventBaseOam_64x64,
    .subspriteTables = sOamTables_64x64,
    .anims = sAnimTable_UnownKing,
    .images = sPicTable_UnownKing,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
gObjectEventGraphicsInfoUnown(Question);    // gObjectEventGraphicsInfo_UnownQuestion
gObjectEventGraphicsInfoUnown(Exclamation); // gObjectEventGraphicsInfo_UnownExclamation
