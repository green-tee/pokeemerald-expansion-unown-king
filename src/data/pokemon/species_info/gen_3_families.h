...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #else
        .abilities = { ABILITY_STEADFAST, ABILITY_FRISK, ABILITY_JUSTIFIED },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SLAKING] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRUANT, ABILITY_NONE, ABILITY_NONE, ABILITY_UNKNOWN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHELGON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_SALAMENCE}),
    },
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE, ABILITY_UNKNOWN },
        .bodyColor = BODY_COLOR_RED,
