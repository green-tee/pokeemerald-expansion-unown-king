...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .expYield = 56,
        .evYield_Defense = 1,
        .itemCommon = RANDOM_ITEM_GEM,
        .itemRare = RANDOM_ITEM_GEM,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
    ...
    [SPECIES_BOLDORE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MOON_STONE, SPECIES_GIGALITH}),
    },
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MUMMY, ABILITY_NONE, ABILITY_NONE, ABILITY_UNKNOWN },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ARCHEOPS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_DEFEATIST, ABILITY_NONE, ABILITY_NONE, ABILITY_UNKNOWN },
        .bodyColor = BODY_COLOR_YELLOW,
