...
{
    [MAPSEC_ENTRANCE] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ROOFTOP] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_WESTERN_HALLWAY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EAST_OF_TEMPLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WEST_OF_TEMPLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WESTERN_WING] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CHAMBER_OF_TRUTH] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_EASTERN_WING] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_EASTERN_HALLWAY] = MAPPOPUP_THEME_UNDERWATER,
    ...
    [MAPSEC_ROOM_BAGON] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROOM_NINCADA] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SAFARI_ZONE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BATTLE_FRONTIER] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ENCLOSED_GARDEN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_HOLLOW_ROOM] = MAPPOPUP_THEME_STONE,
    [MAPSEC_METEOR_FALLS2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_TEMPLE] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_JAGGED_HALLWAY] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FIERY_PATH2] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PITCH_BLACK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNOWN_KING_PRISON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEALED_CHAMBER] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ABYSS_OF_THE_END] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_UNDERWATER_JAGGED_HALLWAY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_TERRA_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_UNDERWATER_ETERNAL_POND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_TEMPLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_UNDERWATER_POND_OF_GRACE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_WESTERN_HALLWAY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EAST_OF_TEMPLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WEST_OF_TEMPLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WESTERN_WING] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CHAMBER_OF_TRUTH] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EASTERN_WING] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EASTERN_HALLWAY] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_ROOM_BAGON] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROOM_NINCADA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SAFARI_ZONE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BATTLE_FRONTIER] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ENCLOSED_GARDEN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_HOLLOW_ROOM] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_METEOR_FALLS2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TEMPLE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_JAGGED_HALLWAY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FIERY_PATH2] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PITCH_BLACK] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNOWN_KING_PRISON] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SEALED_CHAMBER] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ABYSS_OF_THE_END] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_UNDERWATER_JAGGED_HALLWAY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_TERRA_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_ETERNAL_POND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_TEMPLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_UNDERWATER_POND_OF_GRACE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
