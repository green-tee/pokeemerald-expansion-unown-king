...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    ...
    {TRAINER_CLASS_FIGHTER, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    {TRAINER_CLASS_SWIMMER_F, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {TRAINER_CLASS_POKEFAN, TRAINER_ENCOUNTER_MUSIC_TWINS},
    {TRAINER_CLASS_BEAST_TAMER, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    ...
    {TRAINER_CLASS_SCOUNDREL, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_BREEDER, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    ...
    {TRAINER_CLASS_MAIDEN, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    ...
    {TRAINER_CLASS_UNOWN_KING, TRAINER_ENCOUNTER_MUSIC_MALE},
