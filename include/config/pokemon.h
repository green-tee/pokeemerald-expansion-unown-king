...
#define P_UPDATED_TYPES             GEN_7  // Since Gen 6, several Pokémon were changed to be partially or fully Fairy type.
...
#define P_UPDATED_FRIENDSHIP        GEN_5  // Since Gen 8, the base friendship of certain Pokémon was changed.
#define P_UPDATED_EVS               GEN_5  // Some Pokémon have received EV updates after their introduction.
...
#define P_EVOLUTION_LEVEL_1_LEARN   GEN_5  // In Gen 8+, Pokémon evolving while at level 1 do not get the chance to learn their level 1 moves, while before they did.

// Evolution settings
#define P_FRIENDSHIP_EVO_THRESHOLD   GEN_5  // Since Gen 8, Pokémon that evolve by friendship evolve at or above 160 friendship instead of 220.

// Breeding settings
#define P_NIDORAN_M_DITTO_BREED        GEN_5                     // Since Gen 5, when Nidoran♂ breeds with Ditto it can produce Nidoran♀ offspring. Before, it would only yield male offspring. This change also applies to Volbeat.
...
#define P_EGG_HATCH_LEVEL              GEN_5                     // Since Gen 4, Pokémon will hatch from eggs at level 1 instead of 5.
...
#define P_KADABRA_EVERSTONE         GEN_5  // Since Gen 4, Kadabra can evolve even when holding an Everstone.
#define P_SHUCKLE_BERRY_JUICE       GEN_5  // In Gen 2, Shuckle had a 1/16 chance of converting Berry that it's holding into Berry Juice. Enabling this will allow Shuckle to do this with an Oran Berry, which is the spiritual succesor of the Berry item.
...
#define P_ARCEUS_UNIQUE_FORM_ICONS      GEN_5  // Since Gen 9, Arceus additionally changes its icon to reflect its current form.
...
#define P_SHOW_TERA_TYPE                 GEN_5  // Since Gen 9, the Tera Type is shown on the summary screen.
...
#define P_EGG_CYCLE_LENGTH               GEN_5  // Since Gen 8, egg cycles take half as many steps as before. Previous Gens have some varied step counts around 255.
