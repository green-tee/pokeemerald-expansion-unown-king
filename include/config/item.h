...
#define I_GRISEOUS_ORB_FORM_CHANGE      GEN_5  // In Gen9+, the Griseous Orb no longer changes Giratina's form when held.
...
#define I_TYPE_BOOST_POWER              GEN_5  // In Gen4+, all regular type boosting held items had their power increased from 10% to 20%. eg. Charcoal
...
#define I_POWER_ITEM_BOOST              GEN_5  // In Gen7+, Power Items grant 8 EVs instead of 4 EVs.
#define I_PREMIER_BALL_BONUS            GEN_5  // In LGPE onwards (Gen8+ here), you are given a Premier Ball for every 10 Poké Balls of any type and in the same purchase. Previously, it only applied to regular Poké Balls and only 1 could be obtained per purchase.
...
// Fishing
#define I_FISHING_BITE_ODDS        GEN_5 // In Gen 1 and Gen 2, the Old Rod has a 100% chance for a bite, Good Rod has a 66% chance for a bite, and Super Rod has a 50% chance for a bite. In Gen 3, all rods have a base 50% chance for a bite. In Gen 4 onwards, the Old Rod has a base 25% chance for a bite, Good Rod has a 50% chance for a bite, and Super Rod has a 75% chance for a bite.
...
#define I_FISHING_ENVIRONMENT      GEN_5 // In Gen 3, the battle environment when fighting a hooked Pokémon is based on the tile the player is standing on. In Gen 4 onwards, the environment is based on tile that is being fished in, resulting in it usually being a water environment.
#define I_FISHING_STICKY_BOOST     GEN_5 // In Gen 3, a Pokemon with Suction Cups or Sticky Hold in the first slot of the party causes the chance for a bite to increase by about 35%. In Gen 4 onwards, it doubles the base bite chance.
