...
#define VAR_STARTER_MON                                  0x4023 // 0 = Electrike, 1 = Houndour, 2 = Vulpix (Alola) 
...
#define VAR_GAIA_EGG_SPECIES                             0x404E // Unused Var
...
#define VAR_TEMP_MOVE_TUTOR_SELECTION  VAR_TEMP_D
