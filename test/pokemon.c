...
TEST("Nature independent from Hidden Nature")
{
    ...
    CreateMonWithNature(&mon, SPECIES_WOBBUFFET, 100, 0, nature, FALSE);
...
TEST("Terastallization type defaults to primary or secondary type")
{
    ...
    CreateMon(&mon, SPECIES_PIDGEY, 100, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
...
TEST("Terastallization type can be set to any type except TYPE_NONE")
{
    ...
    CreateMon(&mon, SPECIES_WOBBUFFET, 100, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
...
TEST("Shininess independent from PID and OTID")
{
    ...
    CreateMon(&mon, SPECIES_WOBBUFFET, 100, 0, TRUE, pid, OT_ID_PRESET, otId, FALSE);
...
TEST("Hyper Training increases stats without affecting IVs")
{
    ...
    struct Pokemon mon;
    CreateMon(&mon, SPECIES_WOBBUFFET, 100, 3, TRUE, 0, OT_ID_PRESET, 0, FALSE);
...
TEST("Status1 round-trips through BoxPokemon")
{
    ...
    CreateMon(&mon1, SPECIES_WOBBUFFET, 100, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
...
TEST("canhypertrain/hypertrain affect MON_DATA_HYPER_TRAINED_* and recalculate stats")
{
    ...
    CreateMon(&gPlayerParty[0], SPECIES_WOBBUFFET, 100, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
...
{
    CreateMon(&gPlayerParty[0], SPECIES_MELMETAL, 100, 0, FALSE, 0, OT_ID_PRESET, 0, FALSE);
